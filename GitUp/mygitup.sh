...
##$LTYLLW    Modify the variables in this script path/s to your local git repo directory/s$LTCYN
...
##$LTGRN    SeaPhor on GitLab  https://gitlab.com/SeaPhor-Repos$LTCYN
